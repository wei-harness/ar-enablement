...
export const MATURITY_STAGES: MaturityStage[] = [
  {
    ...
    labelBdr: 'color-mix(in srgb, var(--danger) 30%, transparent)',
    ...
    actions: [
      'Connect cloud accounts to Harness CCM',
      'Enable Cost Perspectives for visibility baseline',
      'Set up basic anomaly detection',
      'Establish tagging strategy (start with Core Five)',
    ],
  ...
  },
  {
    ...
    labelColor: 'var(--warn)',
    labelBg: 'var(--warn-bg)',
    labelBdr: 'color-mix(in srgb, var(--warn) 30%, transparent)',
    ...
    actions: [
      'Implement tagging strategy with enforcement',
      'Enable Asset Governance with auto-remediation',
      'Set up chargeback/showback reporting',
      'Deploy AutoStopping for non-production environments',
    ],
  ...
  },
  {
    ...
    labelBdr: 'color-mix(in srgb, var(--success) 30%, transparent)',
    desc: 'Full cost allocation with automated governance. Optimization is continuous and automated. Commitments are managed.',
    actions: [
      'Automate RI/SP with Commitment Orchestrator',
      'Deploy Cluster Orchestrator for K8s workloads',
      'Enable unit cost economics and business metrics',
      'Implement FinOps-as-code via IaCM integration',
    ],
    rec: 'Full platform deployment. Commitment Orchestrator and Cluster Orchestrator drive material savings.',
    recColor: 'var(--success)',
    recBg: 'var(--success-bg)',
  },
];
...
export const WORKSHOP_ITEMS: WorkshopItem[] = [
  {
    ...
    desc: 'Review current account structure, tagging strategy, and visibility gaps.',
  },
  {
    n: 2,
    title: 'Maturity Benchmarking',
    desc: 'Score the customer against Crawl/Walk/Run across Inform, Optimize, and Operate pillars.',
  },
  {
    n: 3,
    title: 'Waste Estimation',
    desc: 'Estimate addressable waste by category: non-prod, orphaned resources, over-committed RIs.',
  },
  {
    n: 4,
    title: 'SKU Deployment Roadmap',
    desc: 'Recommended sequence of ARSKU deployment with expected ROI at each phase.',
  },
  {
    n: 5,
    title: 'FinOps Culture Assessment',
    desc: 'Identify persona gaps — who needs to be in the room for FinOps to succeed.',
  },
  {
    n: 6,
    title: '90-Day Quick Win Plan',
    desc: 'Concrete actions for immediate savings with specific Harness ARfeatures mapped to each.',
  },
];
