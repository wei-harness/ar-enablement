...
export const ICP_CRITERIA: IcpCriterion[] = [
  ...
  {
    num: '06',
    title: 'Pain + Incumbent Awareness',
...
export const DISCO_QUESTIONS: DiscoQuestion[] = [
  {
    ...
    green: {
      label: 'Green Flag',
      action: 'Go Deeper',
      text: '"We find out at month-end" / "Finance sends the bill and we try to reverse-engineer it" / "Developers don\'t think about cost until something gets flagged"',
    },
    yellow: {
      label: 'Yellow Flag',
      action: 'Probe Further',
      text: '"We have dashboards but they\'re not in the deployment workflow" — ask who looks at them and how often',
    },
    red: {
      label: 'Red Flag',
      action: 'Deprioritize',
      text: 'Cost policies are embedded in pipelines with real-time engineer feedback',
    },
  ...
  },
  {
    ...
    green: {
      label: 'Green Flag',
      action: 'Go Deeper',
      text: '"We\'ve talked about it but haven\'t done anything" / "It\'s manual and nobody\'s enforced it"',
    },
    yellow: {
      label: 'Yellow Flag',
      action: 'Probe Further',
      text: '"We have some scheduling in place" — ask who owns it and whether it covers all environments',
    },
    red: {
      label: 'Red Flag',
      action: 'Deprioritize',
      text: 'Yes, fully automated — resources stop and start without manual effort',
    },
  ...
  },
  {
    ...
    green: {
      label: 'Green Flag',
      action: 'Go Deeper',
      text: '"We don\'t, really" / "We get surprised monthly" / "AWS alerts are noisy" / "Someone checks the console periodically"',
    },
    yellow: {
      label: 'Yellow Flag',
      action: 'Probe Further',
      text: '"We use AWS Cost Explorer" — ask whether alerts are automated and who acts on them',
    },
    red: {
      label: 'Red Flag',
      action: 'Deprioritize',
      text: 'Proactive anomaly detection fires to the right owner before it escalates',
    },
  ...
  },
  {
    ...
    green: {
      label: 'Green Flag',
      action: 'Go Deeper',
      text: '"We can\'t really answer that" / "We export from AWS and build it in Excel" / "Finance asks and it takes days"',
    },
    yellow: {
      label: 'Yellow Flag',
      action: 'Probe Further',
      text: '"We have dashboards" — ask if they\'re trusted by leadership and map to actual business units',
    },
    red: {
      label: 'Red Flag',
      action: 'Deprioritize',
      text: 'Dedicated FinOps platform handles chargeback with full business context already',
    },
    why: "Chargeback is the primary ARbusiness case. If they can't answer this confidently, there's usually a VP or CFO asking — and someone's career depends on fixing it.",
  ...
  },
  {
    ...
    green: {
      label: 'Green Flag',
      action: 'Go Deeper',
      text: '"Mostly finance" / "Engineers don\'t look at cost day-to-day" / "It\'s a separate reporting cycle"',
    },
    yellow: {
      label: 'Yellow Flag',
      action: 'Probe Further',
      text: "\"We're trying to shift it left but it's a work in progress\" — ask what's blocking adoption",
    },
    red: {
      label: 'Red Flag',
      action: 'Deprioritize',
      text: 'Cost is a first-class metric in engineering reviews and sprint planning',
    },
  ...
  {
    num: 'Q6',
    topic: 'RI / Savings Plans',
    q: "Are you managing Reserved Instances or Savings Plans today — and do you feel like you're getting the most out of them?",
    green: {
      label: 'Green Flag',
      action: 'Go Deeper',
      text: '"Someone owns a spreadsheet" / "Our coverage is low" / "We\'re not sure if we\'re over- or under-committed"',
    },
    yellow: {
      label: 'Yellow Flag',
      action: 'Probe Further',
      text: '"We have some automation" — ask what tool, how proactive it is, and whether it covers all account types',
    },
    red: {
      label: 'Red Flag',
      action: 'Deprioritize',
      text: 'Dedicated commitment management tool, satisfied with coverage and savings rate',
    },
  ...
  },
  {
    ...
    green: {
      label: 'Green Flag',
      action: 'Go Deeper (A)',
      text: '"We have a FinOps / CloudOps function" — ask to meet them; this is your real economic buyer',
    },
    yellow: {
      label: 'Yellow Flag',
      action: 'Probe Further',
      text: '"It\'s shared but nobody fully owns it" / "Finance owns the budget but engineering controls the spend" — this tension is a direct ARentry point',
    },
    red: {
      label: 'Red Flag',
      action: 'Deprioritize',
      text: 'Well-resourced FinOps team with a mature, satisfying toolset',
    },
  ...
  },
  {
    ...
    green: {
      label: 'Green Flag',
      action: 'Go Deeper (A)',
      text: '"We have a FinOps team / CloudOps function" — ask for an intro immediately; this is your economic buyer',
    },
    yellow: {
      label: 'Yellow Flag',
      action: 'Go Deeper (B)',
      text: '"It falls to us but nobody really owns it" — latent pain, likely a budget conversation waiting to happen',
    },
    red: {
      label: 'Red Flag',
      action: 'Deprioritize',
      text: "Well-funded FinOps team using CloudHealth / Cloudability and they're satisfied",
    },
    why: 'Either answer is actionable: no owner = latent pain and a budget conversation waiting; dedicated owner = active buyer ready to sponsor a ARinitiative.',
    solves: ['Full ARPlatform'],
  },
];
...
export const CCM_MOTIONS: Motion[] = [
  {
    ...
    pitch:
      'You have K8s visibility — Cluster Orchestrator takes it to continuous, automated optimization with zero application impact.',
    expand: {
      ...
      starter:
        'You can see the cost by namespace. Do you know why some workloads are costing 3x what they should? Cluster Orchestrator right-sizes and spot-optimizes automatically.',
    },
  },
  {
    ...
    pitch:
      "You know what you're spending. Commitment Orchestrator automates the decisions that turn that spending into savings — RIs, Savings Plans, renewals, rebalancing.",
    expand: {
      ...
      starter:
        'What is your current RI coverage percentage? If I told you we could get you to 91% coverage and save $3M+ in the next 12 months — with zero manual effort — would that be worth 30 minutes?',
    },
  },
  {
    id: 'any-autostopping',
    ...
    tagline: 'Fastest path to ROI in any ARinstall.',
    targets: ['FinOps', 'DevOps', 'CFO'],
    targetColors: ['var(--accent)', 'var(--warning-amber)', 'var(--state-success)'],
    pitch:
      'No matter where a customer is in their ARjourney, AutoStopping often pays for the entire platform within the first billing cycle.',
    expand: {
      ...
      starter:
        'What percentage of your cloud spend is non-production? A typical dev environment is idle 76% of the week. AutoStopping turns that idle time into savings — automatically.',
    },
  },
  {
    id: 'ccm-ai',
    ...
    pitch:
      '98% of FinOps teams are now managing AI spend — but only 23% can accurately measure AI ROI. AI Cost Management is the platform built for that gap.',
    expand: {
      ...
      starter:
        'How are you currently tracking the ROI of your AI and LLM infrastructure investments? 98% of FinOps teams manage AI spend — but only 23% can measure it. We are building that platform.',
    },
  },
];
...
export const OTHER_MOTIONS: Motion[] = [
  {
    ...
    pitch:
      'You are already deploying with Harness — why not see the cost impact of every deployment in the same platform?',
    expand: {
      ...
      starter:
        'You can see deployments in Harness. Do you know which deployment caused your last cost spike? ARconnects your pipeline to your bill.',
    },
  },
  {
    id: 'ff-ccm',
    ...
    pitch:
      'You can toggle a feature — do you know what it costs when you turn it on? ARcorrelates feature flag rollouts to cost anomalies in real-time.',
    expand: {
      ...
      starter:
        'When you rolled out your last major feature, did you see a cost spike? Do you know exactly which flag caused it? ARgives you that correlation in real-time — before it hits your bill.',
    },
  },
  {
    id: 'sei-ccm',
    ...
    pitch:
      'SEI tells you how fast engineering ships. ARtells you what it costs. Together they give you the full ROI picture: engineering output per dollar of cloud spend.',
    expand: {
      ...
      starter:
        'You can measure deployment frequency and change failure rate. Do you know what each deployment costs to run in production? ARadds the financial dimension to your engineering intelligence.',
    },
  },
  {
    id: 'ci-ccm',
    ...
    pitch:
      'Every CI/CD run consumes cloud resources. ARmakes that cost visible in the same platform — so engineers see the cost impact of their pipelines, not just their deployments.',
    expand: {
      ...
      starter:
        'What does your average CI pipeline run cost per execution? Most teams have no idea — and it adds up. ARconnects your build activity to the exact line on your cloud bill.',
    },
  },
];
...
export const PATHWAYS: Pathway[] = [
  {
    ...
    rationale:
      'CD customers already trust Harness for deployments — the ARconversation starts there. Lead with Cost Insights to establish visibility, then AutoStopping to deliver the first realized savings quickly. Commitment Orchestrator is the next unlock once spend data is trusted.',
  },
  {
    id: 'has-ff',
  ...
  },
  {
    ...
    note: 'On $100M cloud spend',
    rationale:
      'SEI and CI/CD customers are engineering-intelligence buyers. The pitch is cost-per-deployment as the missing KPI — ARadds the financial dimension. AutoStopping directly addresses CI build environment waste, which is often invisible. The combined story: engineering ROI, not just engineering output.',
  },
  {
    id: 'has-insights',
    ...
    rationale:
      'Cost Insights customers have the data foundation. The next move is waste elimination — AutoStopping for non-prod, Asset Governance moving from audit mode to enforcement. Both typically generate enough savings to fund the entire platform.',
  },
  {
    id: 'has-autostop',
    ...
    rationale:
      'AutoStopping customers have eliminated non-prod waste. The next largest bucket is commitment savings — Commitment Orchestrator is the natural move. If K8s spend is significant, Cluster Orchestrator is a parallel track.',
  },
  {
    id: 'full-platform',
    label: 'Full ARPlatform',
    steps: [
      { name: 'CD / CI / FF / SEI', val: 'Cross-sell', desc: 'Connect ARto every Harness module' },
    ...
    rationale:
      'Full ARplatform customers are ready for two conversations: the module cross-sell story and the roadmap urgency story. IaCM shift left, AI Cost Management, and Azure expansion all create urgency and expansion ACV.',
  },
];
    ...
    skus: [
      {
        ...
        tag: 'Required',
        tagColor: 'var(--accent)',
        why: 'Visibility foundation. No other SKU is viable without it. Start here, always.',
      },
      {
        icon: '🛡',
        ...
        why: 'Ships with Cost Insights. Run in audit mode while building tagging strategy — zero risk.',
      },
      {
        icon: '🚀',
        name: 'CD → CCM',
        ...
        why: 'If they have CD, the ARconversation starts with their existing deployments. Lowest friction entry point.',
      },
    ],
  },
  {
    ...
    skus: [
      {
        ...
        why: 'Activate auto-remediation in Asset Governance. Add AutoStopping. Together these fund the platform.',
      },
      {
        icon: '🛡',
        name: 'Asset Governance',
        ...
        tag: 'Enforce Now',
        tagColor: 'var(--state-success)',
        why: 'Move from audit mode to active enforcement. Auto-remediate unused volumes, oversized EC2.',
      },
      {
        icon: '🏗',
        name: 'IaCM Integration',
        color: 'var(--state-success)',
        tag: 'Q2 2026',
        tagColor: 'var(--warning-amber)',
        why: 'Shift left begins here — simulate cost before Terraform completes.',
      },
      {
        icon: '🚩',
        name: 'Feature Flags → CCM',
        ...
        tag: 'Cross-sell',
        tagColor: 'var(--text-muted)',
        why: 'Feature Flags customers start correlating rollout cost impact here — cost-per-feature visibility.',
      },
      {
        icon: '⚙',
        name: 'CI/CD → CCM',
        ...
        tag: 'Cross-sell',
        tagColor: 'var(--text-muted)',
        why: 'CI/CD customers get build pipeline cost attribution — AutoStopping on idle build envs is immediate ROI.',
      },
    ],
  },
  {
    ...
    skus: [
      {
        icon: '🤖',
        name: 'Commitment Orch',
        color: 'var(--warning-amber)',
        tag: 'Largest Lever',
        tagColor: 'var(--warning-amber)',
        why: 'Automate the full RI/SP portfolio. 15–25% additional savings. Set and forget.',
      },
      {
        icon: '⎈',
        name: 'Cluster Orch',
        ...
        tag: 'K8s Heavy',
        tagColor: 'var(--danger)',
        why: '60% avg K8s cost reduction. EKS Karpenter+ with intelligence. AKS Q4 2026.',
      },
      {
        icon: '✦',
        name: 'AI Cost Mgmt',
        ...
        why: '98% of FinOps teams manage AI spend. Only 23% can measure ROI. This is the next frontier.',
      },
      {
        icon: '📈',
        name: 'SEI → CCM',
        ...
        tag: 'Cross-sell',
        tagColor: 'var(--text-muted)',
        why: 'At Run stage, SEI customers add cost-per-deployment to their DORA metrics — full engineering ROI picture.',
      },
    ],
  },
];
...
export const CONVERSATION_STARTERS: ConversationStarter[] = [
  {
    ...
    context: 'Opens the ARconversation with existing CD customers. Trust is already established.',
    ans: "This is the lowest-friction ARentry point for CD customers. They already trust Harness for reliability — connect that trust to cost accountability. Follow up: What if I showed you every deployment's cost impact in the same dashboard you already use?",
  },
  {
    filter: 'CD → CCM',
    ...
    ans: 'Most teams find out from a finance email or a monthly bill review. ARcatches anomalies within hours. The follow-up: Do you want to be the one who finds it, or the one who gets found?',
  },
  {
    ...
    context: 'Feature Flags to AR— real-time cost correlation on rollouts.',
    ans: 'Feature launches are a primary cause of unexpected cost spikes. ARgives you real-time correlation between flag state and cloud cost — before the bad rollout scales to 100% of traffic.',
  },
  {
    filter: 'Feature Flags',
    ...
    ans: 'This reframes ARas a product tool, not just a FinOps tool. Product managers start caring about cloud cost when it becomes part of the launch decision. That is the conversation ARopens.',
  },
  {
    filter: 'SEI',
    q: 'You can measure deployment frequency — do you know what each deployment costs to run in production?',
    context: 'SEI to AR— adds the cost dimension to DORA metrics.',
    ans: 'SEI tells you how fast engineering ships. ARtells you what it costs. The CFO increasingly wants both numbers together. Cost-per-deployment is the KPI that bridges engineering and finance.',
  },
  {
    filter: 'SEI',
    q: 'If you had to rank your engineering teams by cost-efficiency — not just velocity — could you?',
    context: 'Executive-level SEI + ARconversation for VP Engineering or CTO.',
    ans: "This question reframes the engineering ROI conversation. Velocity without cost context is incomplete. ARadds the financial dimension to SEI's engineering intelligence — and gives executives a complete picture.",
  },
  {
    filter: 'CI/CD',
    q: 'What does your average CI pipeline run cost per execution — and does your team know?',
    context: 'CI/CD to AR— pipeline cost visibility angle.',
    ans: 'Most teams have no idea — and it adds up fast. This opens the door to attributing cloud costs to specific pipelines, build stages, and teams. ARconnects your build activity to the exact line on your cloud bill.',
  },
  {
    filter: 'CI/CD',
